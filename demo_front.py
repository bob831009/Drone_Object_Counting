...
# =============My edit Part==============
Image_source_dir = "/auto/extra/b02902015/Drone_Video/Front_View/";
Detect_output_dir = '/auto/extra/b02902015/py-faster-rcnn/front_output/';
IM_NUM = 6;
def Handle_Name(i):
    if(i < 10):
...
if __name__ == '__main__':
    ...
    for i in range(1, IM_NUM):
        ...
        demo(net, Image_source_dir, im_name)
